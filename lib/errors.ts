export const ErrorCode = {
  ...
  WAREHOUSE_CODE_IN_USE: "WAREHOUSE_CODE_IN_USE",
  PURCHASE_ORDER_NOT_FOUND: "PURCHASE_ORDER_NOT_FOUND",
  PURCHASE_ORDER_INVALID_STATUS_TRANSITION: "PURCHASE_ORDER_INVALID_STATUS_TRANSITION",
  PURCHASE_ORDER_RECEIPT_EXCEEDS_ORDERED: "PURCHASE_ORDER_RECEIPT_EXCEEDS_ORDERED",
  STOCK_TRANSFER_NOT_FOUND: "STOCK_TRANSFER_NOT_FOUND",
  STOCK_TRANSFER_INVALID_STATUS_TRANSITION: "STOCK_TRANSFER_INVALID_STATUS_TRANSITION",
  ...
  LEAD_WRONG_ACQUISITION_PATH: "LEAD_WRONG_ACQUISITION_PATH",
  LEAD_ALREADY_CONVERTED: "LEAD_ALREADY_CONVERTED",
  LEAD_NOT_WON: "LEAD_NOT_WON",
  TENDER_NOT_FOUND: "TENDER_NOT_FOUND",
  TENDER_MISSING_BID_AMOUNT: "TENDER_MISSING_BID_AMOUNT",
  TENDER_NOT_YET_SUBMITTED: "TENDER_NOT_YET_SUBMITTED",
  QUOTATION_NOT_FOUND: "QUOTATION_NOT_FOUND",
  QUOTATION_INVALID_STATUS_TRANSITION: "QUOTATION_INVALID_STATUS_TRANSITION",
  PROJECT_DOCUMENT_NOT_FOUND: "PROJECT_DOCUMENT_NOT_FOUND",
  PROGRESS_CLAIM_NOT_FOUND: "PROGRESS_CLAIM_NOT_FOUND",
  PROGRESS_CLAIM_INVALID_STATUS_TRANSITION: "PROGRESS_CLAIM_INVALID_STATUS_TRANSITION",
  DEFECT_ITEM_NOT_FOUND: "DEFECT_ITEM_NOT_FOUND",
  DEFECT_ITEM_INVALID_STATUS_TRANSITION: "DEFECT_ITEM_INVALID_STATUS_TRANSITION",
  SALARY_STRUCTURE_NOT_FOUND: "SALARY_STRUCTURE_NOT_FOUND",
  PAYROLL_PERIOD_NOT_FOUND: "PAYROLL_PERIOD_NOT_FOUND",
  PAYROLL_PERIOD_ALREADY_EXISTS: "PAYROLL_PERIOD_ALREADY_EXISTS",
  PAYROLL_PERIOD_INVALID_STATUS_TRANSITION: "PAYROLL_PERIOD_INVALID_STATUS_TRANSITION",
  PAYROLL_NO_ACTIVE_EMPLOYEES: "PAYROLL_NO_ACTIVE_EMPLOYEES",
...
const DEFAULT_MESSAGES: Record<ErrorCode, string> = {
  ...
  WAREHOUSE_CODE_IN_USE: "This warehouse code is already in use.",
  PURCHASE_ORDER_NOT_FOUND: "Purchase order not found.",
  PURCHASE_ORDER_INVALID_STATUS_TRANSITION:
    "That purchase order status change isn't allowed from the current status.",
  PURCHASE_ORDER_RECEIPT_EXCEEDS_ORDERED: "This receipt quantity exceeds what remains outstanding on the order.",
  STOCK_TRANSFER_NOT_FOUND: "Stock transfer not found.",
  STOCK_TRANSFER_INVALID_STATUS_TRANSITION:
    "That stock transfer status change isn't allowed from the current status.",
  STOCK_TRANSFER_SAME_WAREHOUSE: "The source and destination warehouse must be different.",
  LEAD_NOT_FOUND: "Lead not found.",
  LEAD_INVALID_STATUS_TRANSITION: "That lead status change isn't allowed from the current status.",
  LEAD_WRONG_ACQUISITION_PATH: "This action isn't available for this lead's acquisition path.",
  LEAD_ALREADY_CONVERTED: "This lead has already been converted to a project.",
  LEAD_NOT_WON: "Only a Won lead can be converted to a project.",
  TENDER_NOT_FOUND: "Tender not found.",
  TENDER_MISSING_BID_AMOUNT: "Enter a bid amount before submitting this tender.",
  TENDER_NOT_YET_SUBMITTED: "This tender must be submitted before it can be marked awarded or not awarded.",
  QUOTATION_NOT_FOUND: "Quotation not found.",
  QUOTATION_INVALID_STATUS_TRANSITION: "That quotation status change isn't allowed from the current status.",
  PROJECT_DOCUMENT_NOT_FOUND: "Document not found.",
  PROGRESS_CLAIM_NOT_FOUND: "Progress claim not found.",
  PROGRESS_CLAIM_INVALID_STATUS_TRANSITION:
    "That progress claim status change isn't allowed from the current status.",
  DEFECT_ITEM_NOT_FOUND: "Defect item not found.",
  DEFECT_ITEM_INVALID_STATUS_TRANSITION: "That defect status change isn't allowed from the current status.",
  SALARY_STRUCTURE_NOT_FOUND: "This employee has no salary structure on file.",
  PAYROLL_PERIOD_NOT_FOUND: "Payroll period not found.",
  PAYROLL_PERIOD_ALREADY_EXISTS: "A payroll period already exists for this month.",
  PAYROLL_PERIOD_INVALID_STATUS_TRANSITION:
    "That payroll period status change isn't allowed from the current status.",
  PAYROLL_NO_ACTIVE_EMPLOYEES: "No employees with a salary structure were found to process.",
